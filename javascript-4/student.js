...
const faveColors=['white','pink','yellow'];
...
const me = {
    firstName:'Anchali',
    superHeroName:'superKiki',
    homeTown:'Nantou',
    superPowers:['disappear','dancing','time-travel'],
    superPowerXP:function superPowerXP(){ return Math.floor(Math.random() * 100) + 1 },
    profileImage:function imagine(){ return `https://randomuser.me/api/portraits/med/lego/${Math.floor(Math.random() * 10) + 1 }.jpg`}
}

//////////////////Step 3////////////////////
// Create three variables to hold some data off your me object. The first variable should be '
//regularName' that is the value of your firstName on the me object. 
...
//If any of the colors you chose is 'blue', change it's value to '#4D4DFF' 
//which is just a more appealing color of blue. 
