...
//You should now see the same thing you saw when you first loaded the page but you should now be able t
//o add items to your grocery list with a dynamic total showing. If you double click on an item, it should remove that item
