...
//Have the function take the two parameters and retrun a string that says 
...
//firstName will be your name as a string. s
//tate will be your current state or providence as a string. 
...
//create an empty array called 'reversed'. Using a for loop, loop over the passed in array in reverse 
...
let total = myNumbers.reduce (function(total, el){
	return total + el;
})
...
// Did you know that George Foreman has five sons named George? Let's go ahead and change everyone's name 
//in the notGeorge array to George using .map. Call the new array 'forTheLoveOfGeorge'
...
//let's get a total of the awesomeLevel from all the people. Call the new array 'totallyAwesome'. Use .reduce()

const totallyAwesome = people.reduce(function(total, el){
